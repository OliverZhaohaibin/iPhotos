...
class EditLightSection(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        # Mirror the behaviour applied during the expansion animation by keeping the vertical gap
        # as part of the section widget itself.  Assigning the padding here, rather than relying on
        # layout spacing, guarantees the offset exists before and during the collapse animation so
        # the header never drops when the container starts shrinking.
