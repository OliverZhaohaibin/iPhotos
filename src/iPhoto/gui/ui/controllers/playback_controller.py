...
class PlaybackController:
    ...
    def _toggle_favorite_for_current(self) -> None:
        ...
        # feedback and then re-enable the control once the operation completes.  The
        # playlist controller now reacts to row removals by selecting the closest
        # surviving favourite, keeping the detail surface visible without any
        # additional intervention here.
        self._favorite_button.setEnabled(False)
